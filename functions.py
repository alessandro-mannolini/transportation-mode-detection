...
def train_cnn(model, optimizer, loss_fn, train_loader, val_loader, epochs=20, device="cpu",to_print=True):
...
def train_cnn_exp(model, optimizer, loss_fn, train_loader, val_loader, epochs=20, device="cpu",to_print=True):
